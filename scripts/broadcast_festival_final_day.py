...
MESSAGE_TEXT = (
    "🔔 Attention\n"
    "Сегодня последний день фестиваля, не пропустите:\n"
    "15:00 — Eazy money!\n"
    "17:00 — финалы PRO PARK\n"
    "18:00 — награждение\n\n"
    "🏆 Призовой фонд — 200 000 ₽\n"
    "Призы от партнеров: Anteater, Rollbay, Lava Skates\n\n"
    "Участники, ждем вас! Зрители, приходите поддержать 🔥"
)
